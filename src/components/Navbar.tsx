...
const Navbar = () => {
    return (
        <div className="bg-neutral-800 text-white relative">
            ...
            <NavLink className="w-1/12 z-10" to={"/swap"}><h5 className="text-center font-bold ">Swap</h5></NavLink>
            <NavLink className="w-1/12 z-10" to={"/trade"}><h5 className="text-center font-bold ">Trade</h5></NavLink>
